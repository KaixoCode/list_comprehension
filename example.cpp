...
int main() {
    ...
    std::vector r1 = ((a, b, c) | c <- range(1, 11), b <- range(1, c), a <- range(1, b), a*a + b*b == c*c);
    ...
    std::vector r2 = (a + b | (a, b) <- (range(0, 5), range(0, 5)));
    ...
    std::vector r3 = (value + a | ((key, value), a) <- (data, range(0, 5)));
    ...
    std::vector r4 = (max(a, b) | (a, b) <- std::array<std::pair<int, int>, 3>{ { { 1, 5 }, { 5, 4 }, { 3, 4 } } });
